...
# esto se resuelge enviando con los pares y recibiendo con los impares
    if rank%2==0:
...
#Para una comuncación mas rápida se utilizan arreglos de numpy
...
#También se puede sindecir eltipo de dato
